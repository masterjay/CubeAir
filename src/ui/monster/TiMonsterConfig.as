package ui.monster
{
	...
	public class TiMonsterConfig extends Object
	{
		...
		private static const COMBE_BONUS:int =0.25 	
		public static var m_nNextPoint:int = 0
		private static const m_obSolider:MonsterObject = new MonsterObject(3000,1,300,500);
		private static const m_obBoss:MonsterObject = new MonsterObject(5000,2,450,1000);
		private static const m_obDragon:MonsterObject = new MonsterObject(8000,3,900,3000);
